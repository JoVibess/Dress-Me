...
final class Version20260327151135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE api_token (id INT AUTO_INCREMENT NOT NULL, token_value VARCHAR(255) NOT NULL, is_active TINYINT NOT NULL, activated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, subscription_id INT NOT NULL, UNIQUE INDEX UNIQ_7BA2F5EBBEA95C75 (token_value), INDEX IDX_7BA2F5EB9A1887DC (subscription_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE api_token ADD CONSTRAINT FK_7BA2F5EB9A1887DC FOREIGN KEY (subscription_id) REFERENCES subscription (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE api_token DROP FOREIGN KEY FK_7BA2F5EB9A1887DC');
